...
from libpy.const_datos_neptuno import NOMBRE

def record_data(id_usuario, tabla, id_registro, sin_orden, conector, **kwargs):
    """
    ...
    IN
      ...
      id_registro  <int> -> Si no se indica nada aquí se devuelven todos
      sin_orden    <bool>
      conector     <Conexion>
    ...
    if id_registro != None:
        registro = la_tabla.query_registro(id_registro, **kwargs)
        ...
        if sin_orden:
            ...
            for columna in registro:
                ...
                registro_sin_orden[nombre] = columna
                
            return registro_sin_orden
